                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                ...
                                <div className="w-full max-w-md border-2 border-dashed border-slate-700 rounded-2xl p-10 hover:border-indigo-500/50 hover:bg-slate-800/50 transition-all cursor-pointer group-hover:shadow-[inset_0_0_20px_rgba(99,102,241,0.05)] relative">
                                    ...
                                    <div className="flex flex-col items-center gap-4 relative z-10 w-full">
                                        <div className={`p-4 rounded-full transition-all duration-300 ${file ? 'bg-indigo-500/20 text-indigo-400 w-16 h-16 flex items-center justify-center shrink-0' : 'bg-slate-800 text-slate-400 group-hover:text-indigo-400 group-hover:scale-110 w-16 h-16 flex items-center justify-center shrink-0'}`}>
